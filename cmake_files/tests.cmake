...
add_executable(test_rotate tests/test_rotate.cu)
set_target_properties(test_rotate
        PROPERTIES CUDA_SEPARABLE_COMPILATION ON
)
set_target_properties(test_rotate
        PROPERTIES POSITION_INDEPENDENT_CODE ON
)
set_property(TARGET test_rotate PROPERTY CUDA_ARCHITECTURES OFF)
target_link_libraries(test_rotate photon_propagator_cuda ${Boost_LIBRARIES})
add_test(test_rotate bin/test_rotate)

add_executable(test_cascades_to_photons tests/test_cascades_to_photons.cu)
set_target_properties(test_cascades_to_photons
        PROPERTIES CUDA_SEPARABLE_COMPILATION ON
)
set_target_properties(test_cascades_to_photons
        PROPERTIES POSITION_INDEPENDENT_CODE ON
)
set_property(TARGET test_cascades_to_photons PROPERTY CUDA_ARCHITECTURES OFF)
target_link_libraries(test_cascades_to_photons photon_propagator_cuda ${Boost_LIBRARIES})
add_test(test_cascades_to_photons bin/test_cascades_to_photons ${ICE_MODEL_PATH})

add_executable(test_propagation tests/test_propagation.cu)
set_target_properties(test_propagation
        PROPERTIES CUDA_SEPARABLE_COMPILATION ON
)
set_target_properties(test_propagation
        PROPERTIES POSITION_INDEPENDENT_CODE ON
)
set_property(TARGET test_propagation PROPERTY CUDA_ARCHITECTURES OFF)
